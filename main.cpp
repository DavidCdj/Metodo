...
{
        std:: string name, lesiones, enfermedades, password, peso, altura, edad, cpassword,sexo;
        char condiciontype;
        int  id;
        float imc;
        bool flag;
            ...
            system("cls");
            id=users.size();
            User us(name, id,password, lesiones, enfermedades, stoi(altura), stoi(peso), stoi(edad), sexo);
            users.push_back(us);
